<ul class="widget-topics-list list-unstyled d-flex flex-column trim-last-divider" data-numtopics="{numTopics}">
	...
	<li class="widget-topics d-flex gap-2 flex-column">
		<div class="d-flex gap-3 justify-content-between">
			...
			{{{ if ./thumbs.length }}}
			<a class="topic-thumbs text-decoration-none flex-shrink-0 d-inline-block" href="{relative_path}/topic/{./slug}{{{ if ./bookmark }}}/{./bookmark}{{{ end }}}" aria-label="{{tx("topic:thumb-image")}}">
