...
{{{ each tags }}}
	<div class="d-flex align-items-center gap-2">
		<div class="w-75 p-1 border position-relative">
			<div class="position-absolute bg-info opacity-25 start-0 top-0" style="width: 100%; height:100%; z-index: -1;"></div>

			<div data-width="{./widthPercent}" class="popular-tags-bar position-absolute bg-info opacity-50 start-0 top-0" style="transition: width 750ms ease-out; width: 0%; height:100%; z-index: -1;"></div>
